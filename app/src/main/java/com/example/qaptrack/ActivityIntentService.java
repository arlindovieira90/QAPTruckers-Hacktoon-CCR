...
public class ActivityIntentService extends IntentService {
    ...
    //will be called whenever an activity detection is available

    @Override
    protected void onHandleIntent(Intent intent) {
        //checking if the intent has activity recognition data
        if (ActivityRecognitionResult.hasResult(intent)) {
            ...
            PreferenceManager.getDefaultSharedPreferences(this)
                    .edit()
                    .putString(MainActivity.DETECTED_ACTIVITY, detectedActivitiesToJson(detectedActivities))
                    .apply();
